    ...
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) handleClose(); }}>
      ...
      >
        ...
        >
          ...
          >
            <img src={`${import.meta.env.BASE_URL}img/bandeira.png`} alt="" className="inline-block" style={{ height: '1.6rem', width: 'auto', verticalAlign: 'middle', marginRight: '0.4rem' }} />Roubar de quem?
          </DialogTitle>
          ...
          <div className="flex flex-col gap-3">
            {!selectedTarget ? (
              ...
              <>
                ...
                >
                  <img src={`${import.meta.env.BASE_URL}img/coco.png`} alt="" className="inline-block" style={{ height: '1.6rem', width: 'auto', verticalAlign: 'middle', marginRight: '0.4rem' }} />Roubar Cocos
                </button>
