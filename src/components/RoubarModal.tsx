            ...
            {!selectedTarget ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start min-w-0 flex-1">
                      ...
                      <span style={{ fontFamily: 'Quicksand, sans-serif', fontSize: '0.78rem', color: COLORS.marromProfundo, opacity: 0.65 }}>
                        🥥 {target.coins} · <img src={`${import.meta.env.BASE_URL}img/tikkimask.jpg`} alt="" className="inline-block" style={{ height: '1.1rem', width: 'auto', verticalAlign: 'middle' }} /> {target.stars}
                      </span>
                    </div>
              ...
              <>
                ...
                >
                  ...
                  <span style={{ fontFamily: 'Quicksand, sans-serif', fontSize: '0.78rem', color: COLORS.marromProfundo, opacity: 0.65 }}>
                    🥥 {selectedTarget.coins} · <img src={`${import.meta.env.BASE_URL}img/tikkimask.jpg`} alt="" className="inline-block" style={{ height: '1.1rem', width: 'auto', verticalAlign: 'middle' }} /> {selectedTarget.stars}
                  </span>
                </div>
                ...
                >
                  <img src={`${import.meta.env.BASE_URL}img/tikkimask.jpg`} alt="" className="inline-block" style={{ height: '1.6rem', width: 'auto', verticalAlign: 'middle' }} /> Roubar Tikki (-35 🥥)
                  {attacker.coins < 35 && (
