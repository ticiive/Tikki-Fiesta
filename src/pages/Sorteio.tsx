...
const MINIGAMES = [
  {
    ...
    emoji: '🎯',
    duration: 25,
    description: 'TODOS arremessam Tikkoins ao mesmo tempo. Caos absoluto de pontaria!',
  ...
  },
  {
    ...
    emoji: '🎲',
    duration: 90,
    description: 'Aposte secretamente em uma cor. Acertou? Seus Tikkoins dobram!',
    ...
    regras: [
      ...
      'Quem tiver mais Tikkoins ao fim das 3 rolagens vence',
    ],
    type: 'interactive',
  ...
  },
  {
    ...
    emoji: '🎰',
    duration: 60,
    description: 'Descarte todos os seus Tikkoins antes do tempo acabar! Role o dado e descarte os que baterem com a cor.',
  ...
  },
  {
    ...
    emoji: '🔥',
    duration: 60,
    description: 'A música toca e os Tikkoins passam de mão em mão. Quando parar, a cor na tela define quem sai!',
  ...
  },
  {
    ...
    emoji: '🔡',
    duration: 0,
    description: 'Apostem Tikkoins, somem as apostas e descubram a letra. Grite a palavra certa primeiro e leve tudo!',
    objetivo: 'Acumular o maior número de Tikkoins ao fim de todas as rodadas.',
    materials: '24 Tikkoins (6 de cada cor) + 1 Dado de 6 faces',
    regras: [
      'Cada jogador escolhe 1 cor e pega todos os 6 Tikkoins correspondentes',
