...
const MINIGAMES = [
  ...
  },
  {
    ...
    emoji: '🃏',
    duration: 60,
    description: 'O dado fala uma cor, mas a LETRA é o que importa! Corra pela carta certa.',
    objetivo: 'Ao fim dos 60 segundos, quem tiver mais Tikkubes vence.',
    materials: '12 Cartas-Coco (8 jogáveis + 4 armadilhas) + Dado de 6 cores + Tikkubes',
    regras: [
      'Setup: embaralhe as 12 cartas e espalhe 6 na mesa viradas pra cima',
      'Líder rola o dado — a cor sorteada revela a letra da carta correta',
      'A (Azul/Amarelo): Âncora, Abacaxi | V (Vermelho/Verde): Vulcão, Viseira',
      'R (Rosa): Raquete, Rede | L (Laranja): Limão, Lula',
      'Armadilhas que não valem: Barco, Coco, Folha, Peixe',
      'A cor visual da carta NÃO bate com a letra — isso é a pegadinha!',
      'TODOS correm ao mesmo tempo pra pegar a carta com a inicial da cor do dado',
      'Quem pegou a certa: +1 Tikkube da Banca central',
      'Quem pegou a errada: -1 Tikkube pra Banca (mínimo zero)',
      'Se a cor sorteada não tem carta válida na mesa: líder relança o dado, sem penalidade',
      'A cada rodada: devolve cartas, embaralha tudo e espalha 6 novas',
      'Desempate: 1 rolagem extra, os empatados disputam',
    ],
    type: 'physical',
  },
  {
    ...
    regras: [
      'Setup: junte todos os 24 Tikkubes na Banca central; cada jogador pega 3',
      'A rodada tem 3 rolagens do dado. Em cada uma:',
      '1) Cada jogador aposta secretamente no app (escolhe uma cor)',
      '2) Separa fisicamente os Tikkubes apostados na frente do seu lugar',
      '3) App revela as apostas de todos ao mesmo tempo',
      '4) Líder rola o dado físico na mesa',
      '5) Acertou: recupera os apostados + 1 Tikkube extra da Banca por cada apostado (DOBRA)',
      '6) Errou: os Tikkubes apostados vão pra Banca',
      '7) Apostou 0 (passou a vez): não ganha nem perde nada',
      'Após as 3 rolagens: quem tiver mais Tikkubes vence',
      'Desempate: 1 rolagem extra — cada empatado aposta 1 Tikkube numa cor; repete se necessário',
    ],
    type: 'interactive',
